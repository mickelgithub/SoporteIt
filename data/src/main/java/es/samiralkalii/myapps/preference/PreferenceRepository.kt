...
class PreferenceRepository(val preferences: IPreferences) {
    ...
    suspend fun updateProfileImage(profileImage: String, remoteProfileImage: String)= preferences.updateProfileImage(profileImage, remoteProfileImage)
    ...
    suspend fun updateMemberConfirmed(confirmationData: Map<String, Any?>)= preferences.updateMemberConfirmed(confirmationData)
}
...
interface IPreferences {
    ...
    suspend fun updateProfileImage(profileImage: String, remoteProfileImage: String)
    ...
    suspend fun updateMemberConfirmed(confirmationData: Map<String, Any?>)
}
